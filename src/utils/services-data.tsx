export const services = [
  {
    title: "Next-Gen Intelligent Workflows",
    description: "Boost productivity by streamlining routine operations.",
    icon: (
      <svg
  ...
  {
    title: "Immediate Performance Metrics",
    description: "Make smarter decisions with live, actionable intelligence.",
    icon: (
  ...
  {
    title: "Intelligent Trend Prediction",
    description: " Identify opportunities and prevent issues before they arise.",
    icon: (

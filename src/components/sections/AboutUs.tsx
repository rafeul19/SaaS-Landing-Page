    ...
    <section id="about-us">
      ...
      <Container className="flex flex-col md:flex-row gap-10 lg:gap-12 items-center">
        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
          ...
          <Paragraph>
            <br></br>
            We’re dedicated to empowering businesses through transformative AI
            solutions. Backed by cutting-edge research and innovative algorithms,
            our expert team delivers a platform designed to adapt seamlessly to
            your unique challenges. Partner with us and take the lead in your
          ...
          <div className="pt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-arrows-up-from-line-icon lucide-arrows-up-from-line"
              >
                <path d="m4 6 3-3 3 3" />
                <path d="M7 17V3" />
